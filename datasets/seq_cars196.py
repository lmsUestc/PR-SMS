...
from datasets.utils.continual_dataset import ContinualDataset,store_masked_loaders  #, fix_class_names_order, store_masked_loaders
...
from backbone.ResNet18 import myresnet18
...
class SequentialCars196(ContinualDataset):
    ...
    def get_backbone():
        ...
        if type(SequentialCars196.N_CLASSES_PER_TASK) == list:
            return myresnet18(sum(SequentialCars196.N_CLASSES_PER_TASK))
        else:
            return myresnet18(SequentialCars196.N_CLASSES_PER_TASK * SequentialCars196.N_TASKS)
