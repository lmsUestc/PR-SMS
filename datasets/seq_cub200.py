...
from backbone.ResNet50 import resnet50,myresnet50
...
class SequentialCUB200(ContinualDataset):
    ...
    def get_backbone(hookme=False):
        ...
        #return myresnet50(num_classes, pretrained=False)

        return myresnet18(SequentialCUB200.N_CLASSES_PER_TASK * SequentialCUB200.N_TASKS)
