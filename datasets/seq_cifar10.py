...
class SequentialCIFAR10(ContinualDataset):
    ...
    def get_data_loaders_AccordingTaskIndex(self,taskIndex) -> Tuple[torch.utils.data.DataLoader, torch.utils.data.DataLoader]:
        """Class method that returns the train and test loaders."""
        transform = self.TRANSFORM
        ...
        train, test = getdataload(train_dataset, test_dataset, self,taskIndex)
        return train, test
    ...
    def get_backbone():
        ...
        return myresnet18(SequentialCIFAR10.N_CLASSES_PER_TASK
                        * SequentialCIFAR10.N_TASKS)
