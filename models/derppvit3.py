...
#############################
class DerppViT3(ContinualModel):
    NAME = 'derppvit3'
    ...
    def __init__(self, backbone, loss, args, transform):
        ...
        self.newOptimizer = self.get_optimizerByParameters(self.slowNet.parameters())
        parameters = self.classifier.parameters()
        self.newOptimizer.add_param_group({'params': parameters, 'lr': self.args.lr})
        # newOptimizer.add_param_group({'params': self.slowNet.parameters(), 'lr': self.args.lr})
